...
public:
    ...
    Button(const sf::Font& font, const std::string& text = "", const sf::Vector2f& size = {80.f, 20.f}, unsigned int characterSize = 11)
    ...
    void setStyle(State state, const Style& style) {
        switch (state) {
        case State::Normal:   m_normalStyle = style; break;
        case State::Hovered:  m_hoverStyle = style; break;
        case State::Pressed:  m_pressedStyle = style; break;
        case State::Disabled: m_disabledStyle = style; break;
        }
        applyCurrentStyle();
    }
    ...
    void setFillColor(State state, sf::Color color) {
        switch (state) {
        case State::Normal:   m_normalStyle.fillColor = color; break;
        case State::Hovered:  m_hoverStyle.fillColor = color; break;
        case State::Pressed:  m_pressedStyle.fillColor = color; break;
        case State::Disabled: m_disabledStyle.fillColor = color; break;
        }
        applyCurrentStyle();
    }
    ...
    void setTextColor(State state, sf::Color color) {
        switch (state) {
        case State::Normal:   m_normalStyle.textColor = color; break;
        case State::Hovered:  m_hoverStyle.textColor = color; break;
        case State::Pressed:  m_pressedStyle.textColor = color; break;
        case State::Disabled: m_disabledStyle.textColor = color; break;
        }
        applyCurrentStyle();
    }
...
public:
    ...
    void handleEvent(const sf::Event& event, const sf::Vector2f& parentMousePos) override {
        ...
        // Transform coordinates into container's local space
